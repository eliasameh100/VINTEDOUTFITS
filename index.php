...
<style>
    body{
    background-image: url(assets/images/images 4.jpg);
    ...
    <div class="container-fluid">
        ...
        <center>
            <div class="container ">
                <img class="" src="assets/images/suit.png" alt="">
                <img class="" src="assets/images/clothes2.jpg" alt="">
                <img class="" src="assets/images/clothes.jpg" alt="">
            </div>
        </center>
        <div class="my-2 container text-center">
        ...
        <center>
            <div class="container ">
                <img class="" src="assets/images/Asym.png" alt="">
                <img class="" src="assets/images/bermuda.png" alt="">
                <img class="" src="assets/images/slip.jpg" alt="">
            </div>
        </center>
        <div class="my-2 container text-center">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis, incidunt.
        ...
        <center>
            <div class="container ">
                <img class="" src="assets/images/download.jpg" alt="">
                <img class="" src="assets/images/images (1).jpg" alt="">
                <img class="" src="assets/images/images (3).jpg" alt="">
            </div>
        </center>
        <center>
            <div class="my-2">
                <a class="btn btn-info text-center" href="index.php#">Top^</a>
            </div>
        </center>
</body>
</html>